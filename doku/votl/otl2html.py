...
styleSheet = "/home/boffel/.scripts/boffel/vo/otl2html_nnnnnn.css"
inlineStyle = 0
...
def printHeader(linein):
  ...
  print "<html><head><meta charset='utf-8'><title>" + getTitleText(linein) + "</title>"
  print "<script type=\"text/javascript\" src=\"CollapsibleLists.js\"></script></head>"
  print"<!--  $Revision: 1.52 $ -->"
  print"<!--  $Date: 2008/10/11 22:04:09 $ -->"
  print"<!--  $Author: noel $ -->"
  try:
